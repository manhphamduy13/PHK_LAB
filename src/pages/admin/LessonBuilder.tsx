    ...
    <div className="flex h-[calc(100vh-5rem)] bg-slate-50 -m-8 font-sans">
      ...
      <div className="w-72 bg-white border-r-2 border-slate-200 flex flex-col h-full z-10">
        <div className="p-4 border-b-2 border-slate-100">
          <h2 className="font-black text-slate-900 text-lg uppercase tracking-wider">
            Khối nội dung
          </h2>
        </div>
        <div className="p-4 flex-1 overflow-y-auto space-y-2">
          {BLOCK_TYPES.map((bt) => (
            ...
            >
              <div
                className={`p-2 bg-slate-50 rounded-lg group-hover:scale-110 transition-transform ${bt.color}`}
              >
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden relative">
        ...
        <div className="h-16 bg-white border-b-2 border-slate-200 flex items-center justify-between px-6 shrink-0 shadow-sm z-10">
          <div className="flex items-center gap-4">
            ...
            <span
              className={`px-2 py-1 text-xs font-bold rounded uppercase tracking-wider ml-2 border ${
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={handleSave}
              disabled={saving}
              className="flex items-center gap-2 px-4 py-2 bg-blue-500 text-white font-bold rounded-xl hover:bg-blue-600 transition-colors shadow-sm disabled:opacity-50"
            >
        ...
        <div className="flex-1 overflow-y-auto p-8 bg-slate-100">
          <div className="max-w-3xl mx-auto space-y-4 pb-20">
            ...
            <button
              ...
              className="w-full py-4 border-2 border-dashed border-slate-300 rounded-2xl text-slate-400 font-bold hover:bg-slate-200 hover:text-slate-600 transition-colors flex items-center justify-center gap-2"
            >
            ...
            <div className="space-y-6">
              ...
              {blocks.find((b) => b.id === activeBlock)?.type === "quiz" && (
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full p-3 bg-slate-50 border-2 border-slate-200 rounded-xl font-bold outline-none"
                    placeholder="VD: q_123"
                  />
                </div>
              )}
            </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between p-3 bg-blue-50 border-2 border-blue-200 rounded-xl">
                  <div>
                    ...
                    <p className="text-xs font-bold text-blue-500 mt-1 uppercase">
                      Just now
                    </p>
                  </div>
                </div>
                <div className="flex items-center justify-between p-3 bg-slate-50 border-2 border-slate-200 rounded-xl">
                  ...
                  <button className="text-xs font-bold text-slate-400 hover:text-blue-500 hover:underline">
                    Rollback
                  </button>
                </div>
                <div className="flex items-center justify-between p-3 bg-slate-50 border-2 border-slate-200 rounded-xl">
