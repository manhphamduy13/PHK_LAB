    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in duration-500">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-slate-500 font-medium">
          Hoàn thành bài tập để nhận XP và điểm Mastery
        </p>
      </div>
      ...
      {assignments.length === 0 ? (
        ...
        <div className="space-y-4">
          {assignments.map((a: any) => (
            <div
              key={a.id}
              className="bg-white p-6 rounded-3xl border-2 border-b-8 border-slate-200 flex items-center justify-between"
            >
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4 mt-2">
                    ...
                    <span
                      className={`px-2 py-1 text-xs font-black uppercase rounded-lg border ${
                        a.status === "COMPLETED"
              ...
              <div>
                <button
                  onClick={() =>
                    a.lessonId
                      ? navigate(`/student/lessons/${a.lessonId}`)
                      : navigate("/student/exercises")
                  }
                  className="px-6 py-3 bg-blue-500 text-white font-black rounded-xl border-b-4 border-blue-700 active:border-b-0 active:translate-y-1 transition-all"
                >
